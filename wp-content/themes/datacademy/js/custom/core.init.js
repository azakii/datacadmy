...
function themerex_ready_actions() {
	...
	jQuery('.menu_main_wrap ul#menu-main').clone().removeAttr('id').removeClass('menu_main_nav').addClass('menu_main_responsive').insertAfter('.menu_main_wrap ul#menu-main');
	...
	themerex_init_sfmenu('.menu_main_wrap ul#menu-main, .menu_user_wrap ul#menu_user');

	// Slide effect for main menu
	if (THEMEREX_GLOBALS['menu_slider']) {
		jQuery('#menu-main').spasticNav({
