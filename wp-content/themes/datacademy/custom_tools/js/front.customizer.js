...
custom_options  +=	'<a href="#" id="co_toggle" class="icon-cog-1"></a>';
...
custom_options  +=				'<div class="iColorPicker" data-options="link_color" data-value="#f15a23"><span>Color1</span></div>';
custom_options  +=				'<div class="iColorPicker" data-options="menu_color" data-value="#26c9c3"><span>Color2</span></div>';
custom_options  +=			'</div>';
custom_options  +=		'</div>';
custom_options  +=	'</div>';
custom_options  +='</div>';
