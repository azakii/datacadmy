...
<script src="<?php echo get_template_directory_uri(); ?>/js/widgets.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.fancybox-buttons.js"></script>
<script>
